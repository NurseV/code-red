...
const AuditLogView: React.FC = () => {
    ...
    return (
        <div>
            <div className="p-4 bg-dark-bg mb-4 rounded-lg flex items-center space-x-4">
                <div className="flex-grow">
                    ...
                    <select
                        ...
                        className="bg-dark-card border border-dark-border rounded-md py-2 px-3 text-dark-text sm:text-sm"
                    >
